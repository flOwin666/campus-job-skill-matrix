...
const companyMap = {
  'baidu': '百度', 'bytedance': '字节', 'alibaba': '阿里', 'tencent': '腾讯', 'meituan': '美团',
  // 全称映射
  '百度': '百度', '字节跳动': '字节', '阿里巴巴': '阿里', '腾讯': '腾讯', '美团': '美团',
};
const companyColors = {
...
const defaultColor = {bg:'rgba(128,128,128,0.08)',border:'#888',text:'#aaa',badge:''};
...
${Object.entries(companyCounts).map(([c,n]) => {
  const cc = companyColors[c] || defaultColor;
